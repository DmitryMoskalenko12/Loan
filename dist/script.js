...
/* harmony import */ var _modules_main_slider_mainSlider__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./modules/main-slider/mainSlider */ "./src/js/modules/main-slider/mainSlider.js");
...
window.addEventListener('DOMContentLoaded', function () {
  var slider = new _modules_main_slider_mainSlider__WEBPACK_IMPORTED_MODULE_1__["default"]({
    container: '.page',
    btns: '.next'
  });
  slider.render();
  ...
  miniSlider.init();
  var modulesSlider = new _modules_main_slider_sliderMini__WEBPACK_IMPORTED_MODULE_2__["default"]({
  ...
  modulesSlider.init();
  var feedSlider = new _modules_main_slider_sliderMini__WEBPACK_IMPORTED_MODULE_2__["default"]({
  ...
  playerModules.init();
  var diferent = new _modules_difference__WEBPACK_IMPORTED_MODULE_3__["default"]('.officernew', '.officerold', '.officer__card-item');
  diferent.init();
...
function () {
  ...
  _createClass(Difference, [{
    key: "hideCard",
    value: function hideCard(item) {
      item.forEach(function (elem, i, arr) {
        if (i !== arr.length - 1) {
    ...
    key: "bindTriggers",
    value: function bindTriggers(trigger, counter, item) {
      trigger.querySelector('.plus').addEventListener('click', function () {
...
function () {
  ...
  _createClass(Form, [{
    ...
    value: function checkMailInputs() {
      var inputs = document.querySelectorAll('[type="email"]');
      inputs.forEach(function (input) {
    ...
    value: function init() {
      ...
      this.forms.forEach(function (form) {
        form.addEventListener('submit', function (e) {
          ...
          div.textContent = _this.message.loading;
          var formData = new FormData(form);
          var json = JSON.stringify(Object.fromEntries(formData.entries()));

          _this.postData(_this.url, json).then(function () {
            div.textContent = _this.message.success;
          }).catch(function () {
            div.textContent = _this.message.failure;
          }).finally(form.reset(), setTimeout(function () {
            div.remove();
          }, 6000));
        });
      });
...
/***/ "./src/js/modules/main-slider/mainSlider.js":
/*!**************************************************!*\
  !*** ./src/js/modules/main-slider/mainSlider.js ***!
  \**************************************************/
/*! exports provided: default */
...
/* harmony import */ var core_js_modules_web_dom_collections_iterator__WEBPACK_IMPORTED_MODULE_8__ = __webpack_require__(/*! core-js/modules/web.dom-collections.iterator */ "./node_modules/core-js/modules/web.dom-collections.iterator.js");
/* harmony import */ var core_js_modules_web_dom_collections_iterator__WEBPACK_IMPORTED_MODULE_8___default = /*#__PURE__*/__webpack_require__.n(core_js_modules_web_dom_collections_iterator__WEBPACK_IMPORTED_MODULE_8__);
/* harmony import */ var _slider__WEBPACK_IMPORTED_MODULE_9__ = __webpack_require__(/*! ./slider */ "./src/js/modules/main-slider/slider.js");
...
/***/ "./src/js/modules/main-slider/slider.js":
/*!**********************************************!*\
  !*** ./src/js/modules/main-slider/slider.js ***!
  \**********************************************/
/*! exports provided: default */
...
/***/ "./src/js/modules/main-slider/sliderMini.js":
/*!**************************************************!*\
  !*** ./src/js/modules/main-slider/sliderMini.js ***!
  \**************************************************/
/*! exports provided: default */
...
function (_Slider) {
  ...
  function MiniSlider(container, next, prev, activeClass, animate, autoplay, btnWrapper) {
    _classCallCheck(this, MiniSlider);

    return _possibleConstructorReturn(this, _getPrototypeOf(MiniSlider).call(this, container, next, prev, activeClass, animate, autoplay, btnWrapper));
  }
  ...
  _createClass(VideoPlayer, [{
    ...
    value: function bindTrigger() {
      ...
      this.btns.forEach(function (item, i) {
        try {
          var blockedElem = item.closest('.module__video-item').nextElementSibling;
          ...
          if (!item.closest('.module__video-item') || item.closest('.module__video-item').getAttribute('data-disabled') !== 'true') {
            ...
            if (document.querySelector('iframe#frame')) {
              ...
              if (_this.path !== item.getAttribute('data-url')) {
                _this.path = item.getAttribute('data-url');
